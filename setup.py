...
setup(
    ...
    entry_points={"console_scripts": ["gcs_pypi = gcs_pypi.__main__:main"]},
    packages=['gcs_pypi'],
    package_dir={"": "."},
    ...
    extras_require={"dev": ["black==19.*,>=19.3.0.b0; python_version == \"3.*\" and python_version >= \"3.6.0\"", "bumpversion==0.5.3", "dephell==0.*,>=0.8.3; python_version == \"3.*\" and python_version >= \"3.6.0\"", "flake8==3.*,>=3.7.8", "ipdb==0.*,>=0.13.2", "isort==4.*,>=4.3.21", "mock==4.0.2", "pytest>=4.6.5", "pytest-cov==2.*,>=2.7.1"]},
)
